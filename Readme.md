...
**Day9**  [src/Day09Part1.cs](src/Day09Part1.cs) ⭐ One of the easier puzzles, I'd say. My only struggle was that I forgot to cast the answer to long (int can't hold the answer), which probably took me 10 minutes to figure out