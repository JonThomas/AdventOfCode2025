...
**Day8**: [src/Day08Part1.cs](src/Day08Part1.cs) ⭐ [src/Day08Part2.cs](src/Day08art2.cs) ⭐ Points in space is not really something I've done much, and it took a bit of time getting started with Part1. I went for "brute force": Calculating all distances, and solved in the end. Curious about part two now, and if I can build on my brute force method :-) Part2 was straight forward, building very nicely on Part1.

**Day9**  [src/Day09Part1.cs](src/Day09Part1.cs) ⭐ One of the easier puzzles, I'd say. My only struggle was that I forgot to cast the answer to long (int can't hold the answer), which probably took me 10 minutes to figure out. Day two was is lot harder, and still not solved. I used the [Ray-Casting Algorithm](https://www.xjavascript.com/blog/check-if-polygon-is-inside-a-polygon/#2-foundational-concept-the-point-in-polygon-pip-algorithm), but that wasn't enough. I got some help from [xjavascript.com](https://www.xjavascript.com/blog/check-if-polygon-is-inside-a-polygon/#3-3-a-robust-solution-vertex-check-edge-intersection-check) to also include the edge intersection check, but work remains here.

**Day10**  [src/Day10Part1.cs](src/Day10Part1.cs) ⭐